...
<body>
    ...
    <nav id="navbarBelow" class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <a href="https://api.whatsapp.com/send?phone=++15594609608&amp;text=Hi%20getmycertificationdone.com,"
                class="navbar-right-button ms-auto ms-lg-0" target="_blank"><i class="fa-brands fa-whatsapp"></i>
                Whatsapp Now</a>
        </div>
    </nav>